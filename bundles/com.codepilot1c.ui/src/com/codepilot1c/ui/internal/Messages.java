...
public class Messages extends NLS {
    ...
    public static String McpHostPreferencePage_Endpoints;
    public static String McpHostPreferencePage_EndpointsHint;
    public static String McpHostPreferencePage_ColName;
    public static String McpHostPreferencePage_ColPort;
    public static String McpHostPreferencePage_ColTools;
    public static String McpHostPreferencePage_ColToken;
    public static String McpHostPreferencePage_ColStatus;
    public static String McpHostPreferencePage_Add;
    public static String McpHostPreferencePage_Edit;
    public static String McpHostPreferencePage_Duplicate;
    public static String McpHostPreferencePage_Delete;
    ...
    public static String McpHostPreferencePage_StatusDown;
    public static String McpHostPreferencePage_DeleteTitle;
    public static String McpHostPreferencePage_DeleteMessage;
    public static String McpHostPreferencePage_CopiedTitle;
    public static String McpHostPreferencePage_CopiedMessage;
    public static String McpHostProfileDialog_Title;
